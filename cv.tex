    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Lead Full Stack Developer for an IoT-Monitoring Dashboard}
          {Real-time monitoring and timeseries data analysis. Deployment on Mindsphere (Siemens IoT-Platform) and AWS using Lambdas. (GraphQl, REST, Node, Typescript, React)}
      \resumeItemListEnd
